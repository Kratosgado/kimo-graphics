<script lang="ts">
	...
	onMount(async () => {
		project = await getProjectBySlug(page.params.slug);
		setTimeout(() => {
			imagesLoaded = true;
...
{:else}
	<div class="container mx-auto px-4 py-12">
		<div class="max-w-4xl mx-auto">
			<a
				href="/"
				class="inline-flex items-center mb-8 text-sm font-medium hover:text-primary transition-colors"
			>
				<svg
		...
		{#if isLightboxOpen && selectedImage}
			<div class="lightbox-overlay" on:click={closeLightbox} transition:fade={{ duration: 300 }}>
				<div
				...
				>
					...
					<img
						src={selectedImage.base64 || '/favicon.png'}
		...
		<div class="max-w-4xl mx-auto">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<a
					href="/"
					class="card bg-base-100 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group"
				>
					<figure class="aspect-[4/3] overflow-hidden">
						<img
							src="/favicon.png?height=600&width=800"
